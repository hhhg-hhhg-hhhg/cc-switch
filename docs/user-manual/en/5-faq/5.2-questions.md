...
CC Switch for macOS is packaged as a `.dmg` installer. You can download and install it directly from the [Releases page](https://github.com/farion1231/cc-switch/releases).
