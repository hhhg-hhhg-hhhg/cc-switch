...
CC Switch for macOS is packaged as a `.dmg` installer. Download from the [Releases page](https://github.com/farion1231/cc-switch/releases) and install directly.
